...
import { deleteGenres, getGenres } from "../../../_services/genres";
...
export default function AdminGenres() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const [genreData] = await Promise.all([getGenres()]);
  ...
  const handleDelete = async (id) => {
        const confirmDelete = window.confirm("Apakah kamu ingin menghapus genre ini ?");
                    ...
                    >
                      ...
                      <td className="px-4 py-3 flex items-center justify-end relative">
                        ...
                        {openDropdownId === genre.id && (
                          <div
                            id="dropdown"
                            className="absolite right-0 mt-2 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
