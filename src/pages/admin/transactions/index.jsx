...
export default function AdminTransaction() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const [transactionData] = await Promise.all([getTransactions()]);
                ...
                {Transaction.length > 0 ? (
                  Transaction.map((item) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">{item.book_id}</td>
                        ...
                        {/* {openDropdownId === item.id && (
                          ...
                          >
                            ...
                            >
                              <li>
                                <Link
                                  to={`/admin/Transaction/edit/${item.id}`}
